...
NA stands for not available and the reason for that might be there were a lot of NA from n_2021 and we should not count them.
...
na.rm means remove those NA values so the programm will ignore them while running.
